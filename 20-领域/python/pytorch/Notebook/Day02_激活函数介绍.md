...
# $\mathrm{f(x)=\frac1{1+e^{-x}}}$	![](../../../../attachments/pytorch-day_02/Sigmoid函数图像.png)![](../../../../attachments/pytorch-day_02/Sigmoid导函数图像.png)
...
<center>函数表达式
								...
								![](../../../../attachments/pytorch-day_02/Tanh函数图像.png) ![](../../../../attachments/pytorch-day_02/Tanh导函数图像.png)
...
### $\mathrm{Relu}(y)=\begin{cases}y,&y>0\\0,&y\leq0\end{cases}$ ![](../../../../attachments/pytorch-day_02/Relu函数图像.png) ![](../../../../attachments/pytorch-day_02/Relu导函数图像.png)
